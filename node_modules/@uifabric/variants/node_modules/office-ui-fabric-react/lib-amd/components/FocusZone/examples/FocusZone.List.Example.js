define(["require", "exports", "react", "office-ui-fabric-react/lib/Utilities", "@uifabric/react-hooks", "office-ui-fabric-react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/FocusZone", "office-ui-fabric-react/lib/DetailsList"], function (require, exports, React, Utilities_1, react_hooks_1, office_ui_fabric_react_1, Link_1, FocusZone_1, DetailsList_1) {
    ...
    exports.FocusZoneListExample = function () {
        ...
        return (React.createElement(FocusZone_1.FocusZone, { direction: FocusZone_1.FocusZoneDirection.vertical, isCircularNavigation: true, isInnerZoneKeystroke: _isInnerZoneKeystroke, role: "grid" }, ITEMS.map(function (item, index) { return (React.createElement(DetailsList_1.DetailsRow, { key: item.name, item: item, itemIndex: index, columns: COLUMNS, selectionMode: DetailsList_1.SelectionMode.none, selection: selection, styles: detailsRowStyles })); })));
    };
