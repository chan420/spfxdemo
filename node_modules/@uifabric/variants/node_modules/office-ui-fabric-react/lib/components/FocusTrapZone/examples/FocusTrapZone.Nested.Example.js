...
var FocusTrapComponent = /** @class */ (function (_super) {
    ...
    FocusTrapComponent.prototype.render = function () {
        ...
        return (React.createElement(FocusTrapZone, { disabled: !isActive, forceFocusInsideTrap: false },
            React.createElement(Stack, { horizontalAlign: "start", tokens: { childrenGap: 10 }, styles: getStackStyles(isActive) },
                React.createElement(Toggle, { checked: isActive, onChange: this._onFocusTrapZoneToggleChanged, label: 'Enable trap zone ' + zoneNumber, onText: "On (toggle to exit)", offText: "Off", 
