...
var TextFieldControlledExample = /** @class */ (function (_super) {
    ...
    TextFieldControlledExample.prototype.render = function () {
        return (React.createElement(Stack, { tokens: { childrenGap: 15 } },
            React.createElement(TextField, { label: "Basic controlled TextField", value: this.state.value1, onChange: this._onChange1, styles: textFieldStyles }),
            React.createElement(TextField, { label: "Controlled TextField limiting length of value to 5", value: this.state.value2, onChange: this._onChange2, styles: narrowTextFieldStyles })));
    };
